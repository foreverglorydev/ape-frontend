          ...
          <CardBody>
            ...
            <Row>
              ...
              <div>
                ...
                <CardValue fontSize="10px" decimals={2} value={bananaUsdPrice.times(tradingStats.pendingBananaRewards).toNumber()} prefix="$"  />
              </div>
            </Row>
          </CardBody>  
        ): loading ? <PageLoader /> : <Heading fontSize="16px" mb="24px" m="16px" style={{ textAlign: 'center' }}>
