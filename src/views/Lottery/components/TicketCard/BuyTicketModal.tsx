  ...
  return (
    <Modal title={TranslateString(450, 'Enter amount of tickets to buy')} onDismiss={onDismiss}>
      <TicketInput
        ...
        max={fullBalance}
        symbol="TICKET"
        availableSymbol="BANANA"
      />
      <div>
        {/* <Tips>{TranslateString(456, 'Your amount must be a multiple of 1 BANANA')}</Tips> */}
        <Tips>{TranslateString(458, `1 Ticket = ${LOTTERY_TICKET_PRICE} BANANA`)}</Tips>
      </div>
      <div>
        <Announce>
          {TranslateString(
