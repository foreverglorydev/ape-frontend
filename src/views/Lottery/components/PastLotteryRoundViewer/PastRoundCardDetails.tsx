...
import { Heading, CardBody, CardFooter, PancakeRoundIcon, TicketRound } from '@apeswapfinance/uikit'
      ...
      <>
        <CardBody>
          <CardHeading>
            ...
            <LotteryCardHeading
              valueToDisplay={TranslateString(999, `${poolSize.toLocaleString()} BANANA`)}
