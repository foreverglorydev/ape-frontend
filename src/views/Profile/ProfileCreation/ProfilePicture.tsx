...
import { AutoRenewIcon, Button, Card, CardBody, Heading, Skeleton, Text } from '@apeswapfinance/uikit'
          ...
          <NftWrapper>
            {isLoading ? (
              ...
              walletNfts.map((walletNft) => {
                const [firstTokenId] = nftsInWallet[walletNft.index].tokenIds
                ...
                return (
                  <SelectionCard
                    ...
                    key={walletNft.index}
                    value={firstTokenId}
                    image={`/images/nfts/${walletNft.image}`}
