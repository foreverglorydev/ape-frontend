        ...
        <InfoContainer>
          <Flex justifyContent="space-between">
            <StyledText fontFamily="poppins" fontSize="12px">
              {TranslateString(316, 'Lock Time')}:
            </StyledText>
            <StyledText fontFamily="poppins" fontSize="12px">{`${timeUntilLock.days + timeUntilLock.months * 30}d, ${
              timeUntilLock.hours
            }h, ${timeUntilLock.minutes}m`}</StyledText>
          </Flex>
          {blocksUntilStart > 0 && (
            <>
              <StyledText fontFamily="poppins" fontSize="12px">
